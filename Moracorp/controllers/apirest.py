...
class ApiRest(http.Controller):
    ...
    '''
    Probar POST (Creando el producto cuyo id es 1)
    Valor de data: {"id":"1", "nombre":"Prueba"}
    URL COMPLETA (Enviada con POST): http://localhost:8069/gestion/apirest/moracorp.productos?data={"id":"1", "nombre":"Prueba"}
    --------------
    Probar PUT/PATCH (Modificando el producto cuyo id es 1)
    Valor de data: {"id":"1", "nombre":"Prueba2"}
    URL COMPLETA (Enviada con PUT/PATCH): http://localhost:8069/gestion/apirest/moracorp.productos?data={"id":"1", "nombre":"Prueba2"}
    '''
    ...
    '''
    Probar GET (Consultando el producto cuyo id es 1)
    Valor de data: {"id":"1"}
    URL COMPLETA (Enviada con GET): http://localhost:8069/gestion/apirest/moracorp.productos?data={"id":"1"} 
    --------------
    Probar DELETE (Borrando el productos cuyo id es 1)
    Valor de data: {"id":"1"}
    URL COMPLETA (Enviada con DELETE): http://localhost:8069/gestion/apirest/moracorp.productos?data={"id":"1"}  
    '''
    ...
    def apiGet(self, **args):
        ...
        if (http.request.httprequest.method == 'GET'):
            ...
            return "{'estado':'DATO NO ENCONTRADO'}"
